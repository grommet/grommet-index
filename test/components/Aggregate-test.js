...
var __path__ = path.join(__dirname, '../../../src/js/components/index/Aggregate');

var GrommetTestUtils = require('grommet/utils/test/GrommetTestUtils');
var rewire = require('rewire');
var expect = require('expect');

describe('Grommet Index Aggregate', function() {
  it('loads a basic Aggregate component', function(done) {
